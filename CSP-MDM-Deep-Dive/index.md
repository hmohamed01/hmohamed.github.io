...
- **[OMA-URI Atlas](/CSP-MDM-Deep-Dive/oma-uri-atlas.html)** — interactive. The exhaustive companion to the tree: every node Microsoft's DDF v2 files declare, with the verbs each allows, its format and values, and the Windows builds and editions it applies to.
